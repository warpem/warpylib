...
class TestReconstructVolume:
    ...
    def test_write_full_reconstruction_to_mrc(self):
        ...
        output_path = testoutputs_dir / 'full_reconstruction_no_ctf.mrc'
        ...
        output_path = testoutputs_dir / 'full_reconstruction_with_ctf.mrc'
        print(f"  Writing to: {output_path}")
        with mrcfile.new(str(output_path), overwrite=True) as mrc:
        ...
        output_path = testoutputs_dir / 'full_reconstruction_small.mrc'
        print(f"  Writing to: {output_path}")
        with mrcfile.new(str(output_path), overwrite=True) as mrc:
